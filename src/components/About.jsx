...
const About = () => (
  ...
  >
    ...
    >
      <h1 style={{ fontSize: '2.5rem', fontWeight: 700, color: '#64b5f6', marginBottom: '1rem', letterSpacing: '2px', textTransform: 'uppercase' }}>
        About Us
      </h1>
      <p style={{ fontSize: '1.2rem', color: '#e3f2fd', marginBottom: '1.5rem', lineHeight: 1.7 }}>
      ...
      <p style={{ fontSize: '1.1rem', color: '#b3c7e6', marginBottom: '1.5rem', lineHeight: 1.6 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', marginTop: '2rem', flexWrap: 'wrap' }}>
        <div>
          <h3 style={{ color: '#90caf9', fontWeight: 600, fontSize: '1.1rem' }}>Location</h3>
          <p style={{ color: '#e3f2fd', fontSize: '1rem' }}>NIT Patna, India</p>
        </div>
        <div>
          <h3 style={{ color: '#90caf9', fontWeight: 600, fontSize: '1.1rem' }}>Dates</h3>
          <p style={{ color: '#e3f2fd', fontSize: '1rem' }}>29-31 December 2025</p>
        </div>
      </div>
    </div>
  </section>
