...
export default function RegisterPage() {
  ...
  return (
    <>
      {/* Navbar */}
      <div className="fixed top-0 left-0 w-full z-30 bg-[rgba(10,25,47,0.45)] backdrop-blur-xl">
        <div className="max-w-screen mx-auto flex items-center justify-between px-4 sm:px-8 py-4">
          ...
          >
            <svg
              ...
              fill="none"
              stroke="#e3f2fd" // <-- Explicitly set stroke color for visibility
              strokeWidth={2}
              viewBox="0 0 24 24"
            >
              {navOpen ? (
      ...
      <div className="relative min-h-screen w-full bg-gradient-to-br from-[#0a192f] to-[#1e3a8a] text-white py-20 px-4">
        <div className="max-w-5xl w-full mx-auto backdrop-blur-2xl bg-white/10 rounded-3xl shadow-2xl p-10 border border-white/10">
          {/* Header Section */}
